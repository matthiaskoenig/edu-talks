...
- Most of us understand **bar charts** (and pie and line charts)^[@Ariga2022, @Weissgerber2015, @Cairo2016]
...
- Arrange elements in reading order^[@Wong2011]
...
- Explore [SBGN](https://sbgn.github.io/)

:::
::: {.column width="50%"}
- Arrows connect text, pictograms, images and charts into a sequential narrative (storyline)
- Arrows have distinct functions and meaning (be consistent)^[@Tversky2000]
...
- Comprehensive reviews of features and pricing are available^[@Perkel2020, @Cvrckova2019]
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
![](content/PERFECT-KID_sketch.png)
:::
::: {.column width="50%"}
